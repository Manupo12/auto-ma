#!/usr/bin/env python3
"""Test para Análisis de Exigencias — LAURA ROJAS ZUÑIGA, CC 36184789"""

import sys, os
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from backend.doc_generator import generar_analisis_exigencia

# Monkey-patch PDF conversion
import backend.doc_generator as dg
dg._convertir_a_pdf = lambda path: None

datos = {
    "paciente": {
        "nombre": "LAURA ROJAS ZUÑIGA",
        "documento": "36184789",
        "fecha_nacimiento": "24/05/1965",
        "edad": "59",
        "dominancia": "Derecha",
        "estado_civil": "Casada",
    ...
    "empresa": {
        "nombre": "FISCALIA GENERAL DE LA NACION SECCIONAL DE HUILA",
        "nit": "800187609",
    ...
    "laboral": {
        "cargo": "TÉCNICO INVESTIGADOR I",
        "area": "Administrativo / Trabajo en campo",
        "fecha_ingreso_cargo": "19/05/1999",
        "antiguedad_cargo": "25 años y 7 meses",
        "fecha_ingreso_empresa": "19/05/1999",
        "antiguedad_empresa": "25 años y 7 meses",
    ...
    "siniestro": {
        "id_siniestro": "387872120",
        "fecha_evento": "24/06/2021",
        "diagnosticos": "S934 ESGUINCE GRADO I DE TOBILLO DERECHO / S824 FRACTURA OBLICUA DEL PERONÉ DISTAL LATERALIDAD DERECHA / S823 FRACTURA VERTICAL DEL MALÉOLO POSTERIOR DE LA TIBIA DISTAL NO DESPLAZADA LATERALIDAD DERECHA / S932 LESIÓN PARCIAL DE LIGAMENTOS PERONEOASTRAGALINOS Y TIBIOPERONEO ANTEROINFERIOR DE TOBILLO DERECHO",
        "tiempo_incapacidad": "120 días",
    },
    "consulta": {
        "fecha": "12/12/2024",
        "metodologia": "La metodología utilizada para la visita al sitio de trabajo en el Análisis de Exigencia es de tipo entrevista, observacional y descriptivo. Durante la visita, se analizan los procesos y la biomecánica de las actividades que desempeña la servidora, basándose en los criterios técnicos de Positiva Compañía de Seguros S.A. El objetivo es emitir una carta con recomendaciones laborales como seguimiento al diagnóstico reconocido de origen profesional e integral. El análisis de exigencia de trabajo de la servidora LAURA ROJAS ZUÑIGA con C.C. 36184789 se lleva a cabo a través de contacto por correo electrónico, en el cual se recibe la asignación del caso por parte de la IPS Rehabilitación Integral Laboral y Ocupacional (RILO), proveedor aliado de la ARL Positiva. Posteriormente, se programa la visita con la Fiscalía General de la Nación en Neiva para el 12 de diciembre de 2024, a las 9:00 a.m. La visita se realizó en las instalaciones de la Fiscalía General de la Nación en Neiva, donde se llevó a cabo una entrevista con la servidora. Durante la entrevista, se verificaron las actividades que realiza la servidora, los requerimientos y el paso a paso de cada tarea asignada. También se hizo un registro fotográfico, con el consentimiento previo de la servidora, con el fin de socializar las recomendaciones de rehabilitación integral y corroborar si estas se están cumpliendo en el puesto de trabajo actual.",
        ...
        "programa_rhi": "Medicina laboral / Ortopedia y traumatología / Fisiatría / Medicina del dolor / Análisis de exigencias / Carta de recomendaciones",
    ...
    "tareas_criticas": [
        {
            ...
            "conclusion_descripcion": "La actividad puede ser realizada por la trabajadora siguiendo las recomendaciones laborales.",
        },
        {
    ...
    "perfil_exigencias": {
        "vision": {
            "Percepción del Color": 4, "Percepción de Formas": 4,
            "Percepción de Tamaño": 4, "Relaciones Espaciales": 4,
        },
        "audicion": {
            "Ubicación de Fuentes Sonoras": 4, "Discriminación Auditiva": 4,
        },
        "sensibilidad": {
            "Estereognosia": 4, "Barognosia": 4, "Tacto Superficial": 4,
            "Percepción de Temperatura": 4, "Propiocepción": 4,
        },
        "olfato_gusto": {
            "Percepción de olores o sabores": 4, "Discriminación de olores o sabores": 4,
        },
        "motricidad_gruesa": {
            "Postura Bípeda": 3, "Postura Sedente": 4, "Posición de rodillas": 0,
            "Posición de Cuclillas": 0, "Caminar": (4, "Desplazamientos para entregar citaciones"),
            "Subir (escaleras, rampas)": 4, "Bajar (escaleras, rampas)": 4,
            "Levantar pesos": 0, "Transportar pesos": 0, "Agacharse": 0,
            "Inclinarse": 0, "Alcanzar": 1, "Halar": 0, "Empujar": 0,
            "Rapidez Motriz": 4, "Equilibrio": 4,
        },
        "motricidad_fina": {
            "Enganche": 0, "Agarre": (4, "Las actividades realizadas requieren manipulación de Elementos (mouse y documentos)"),
            "Pinza": 2, "Pinza Fina": 0,
        },
        "armonia": {
            "Uso de Ambas Manos": (4, "Habilidades necesarias para el desarrollo de las actividades Laborales de digitación."),
            "Coordinación Ojo - Mano": 4, "Coordinación Bimanual": 4,
            "Coordinación Mano - Pie": 4,
        },
        "cognitivos": {
            "Atención": 4, "Concentración": 4, "Creatividad": 1, "Flexibilidad": 3,
            "Responsabilidad": 4, "Rapidez de Reacción": 4,
            "Percepción Herramientas de Trabajo": 4, "Percepción Estética": 1,
        },
        "sociales_laborales": {
            "Adaptación al Grupo de Trabajo": (4, "Habilidades necesarias para ejecutar su oficio y garantizar la culminación exitosa de las tareas."),
            "Adaptación al Ambiente Laboral": 4, "Relación con la Autoridad": 4,
            "Relación con Compañeros de Trabajo": 4, "Liderazgo": 3,
            "Enfoque Constructivo": 4, "Cooperación": 4, "Confiabilidad": 4,
            "Estabilidad Emocional": 4, "Confianza en sí mismo": 4,
        },
        "laborales": {
            "Rendimiento": (4, "Habilidades necesarias para poder ejecutar cualquier tipo de Labor remunerada."),
            "Asistencia": 4, "Puntualidad": 4, "Compromiso": 4,
            "Autocontrol": 4, "Eficiencia": 4,
            "Organización y Métodos de Trabajo": 4, "Calidad de Trabajo": 4,
            "Cuidado con los elementos de Trabajo": 4, "Higiene": 4,
            "Pulcritud": 4,
        },
    },
    "registro": {
        "elaboro": "BIBIANA HORTA PERDOMO — Fisioterapeuta Esp. SO",
        "reviso": "JENNY MARITZA RIVERA POLANIA — LIDER DE OPERACIONES ARL – IPS RILO",
    },
}

if __name__ == "__main__":
    print("Generando Análisis de Exigencias para LAURA ROJAS ZUÑIGA...")
    try:
